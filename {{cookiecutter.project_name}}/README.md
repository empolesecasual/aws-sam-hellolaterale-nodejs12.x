...
## Deploy the {{cookiecutter.project_name}} application
...
```bash
{{cookiecutter.project_name}}$ sam logs -n HelloLateraleFunction --stack-name aws-store-api --tail
```
...
```bash
aws cloudformation delete-stack --stack-name aws-store-api
```
